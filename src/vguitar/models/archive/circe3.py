...
from vguitar.models.archive.losses import esr_loss, multi_stft_loss, preemph_esr_loss
from vguitar.models.archive.tcn import _GatedLayer, _mixed_sizes, _MixedLayer
...
def _mixed_act_np(
    ...
    """Numpy twin of :class:`vguitar.models.archive.tcn._MixedActivation` on ``(C, T)``.
