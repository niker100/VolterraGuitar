...
def l11(x):
    return 0.00390625 * (
        88179 * x**11 - 230945 * x**9 + 218790 * x**7 - 90090 * x**5 + 15015 * x**3 - 693 * x
    )
...
def build_model(memory_length):
    model = models.Sequential(
        [
            ...
            DenseOrthogonal(
                units=len(activation_functions), activation_functions=activation_functions
            ),
...
if __name__ == "__main__":
    ...
    model.fit(
        X, Y, epochs=1000, batch_size=4096, verbose=1
